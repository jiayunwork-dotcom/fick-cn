...
// TestCheckSuiteClosedRodPasses runs the full cross-check suite on a closed
// rod with a pulse and verifies every check passes.
...
// TestCheckMassConservationClosedRod isolates the mass-conservation check.
...
// TestCheckDtScalingPasses isolates the D*4/t/4 scaling check.
...
// TestCheckPulseDecayPasses isolates the amplification-factor pulse decay
// check.
...
// TestCheckSteadyApproachPasses verifies the analytic steady profile is
// reached by the reference march.
...
// TestReportAggregation checks the all-pass verdict logic of the report.
