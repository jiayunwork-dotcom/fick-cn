...
// CheckMassClosedRod runs a full march on a closed rod and verifies the
// trapezoidal mass is conserved within MassTolerance.  On an open rod mass
// conservation does not apply; the outcome is marked as such so the suite
...
// CheckFluxBalance re-runs the march and verifies that the measured mass
// change of every step matches the boundary fluxes.  Unlike the closed-rod
// check it applies to every boundary combination.
